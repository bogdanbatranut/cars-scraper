...
type MobileDE_DECollyMarketAdapter struct {
	loggingService *logging.ScrapeLoggingService
	propertiesRepo *repos.PropertiesRepository
	builder        *URLBuilder
}

func NewMobileDE_DECollyMarketAdapter(logingService *logging.ScrapeLoggingService, cfg amconfig.IConfig) *MobileDE_DECollyMarketAdapter {
	return &MobileDE_DECollyMarketAdapter{
